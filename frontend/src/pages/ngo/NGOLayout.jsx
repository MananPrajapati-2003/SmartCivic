...
import { LayoutDashboard, Flame, LogOut, Leaf } from "lucide-react";
    ...
    <div className="flex h-screen bg-[#070b14] text-white overflow-hidden">
      <aside className="w-60 shrink-0 bg-[#0c1220] border-r border-white/8 flex flex-col">
        ...
        <div className="p-4 border-b border-white/5">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-full bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center text-sm font-bold shrink-0">
